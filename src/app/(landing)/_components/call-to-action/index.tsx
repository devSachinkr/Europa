    ...
    return (
        <div className="flex flex-col items-start md:items-center gap-y-5 md:gap-y-0">
            ...
            <p className="text-sm md:text-center text-left  text-muted-foreground font-semibold">
                We are a community-driven platform that empowers users to
                connect with like-minded individuals from around the world.
                Whether {"you're"} <br />a seasoned traveler, a curious
                explorer, or simply seeking new adventures, Europa offers a
                diverse range of experiences that will inspire and enrich your
                journey.
            </p>
            <div className="flex md:flex-row flex-col md:justify-center gap-5 md:mt-5 w-full">
                <Button
                    variant={"outline"}
                    className="rounded-xl bg-transparent text-base hover:bg-demonGreen hover:text-themeTextWhite border-demonGreen border-2 "
                >
                    Watch Demo
                </Button>
                <Link href="/sign-in">
