        ...
        <>
            <div className="px-7 flex flex-col">
                ...
                <p className="text-themeTextGray leading-tight">
                    ...
                    Whether {"you're"} a seasoned traveler, a curious explorer,
                    or simply seeking new adventures, Europa offers a diverse
                    range of experiences that will inspire and enrich your
                    journey.
                </p>
